...
module.exports = {
	app: {
		...
		appName: process.env.APP_NAME || 'seqtest',
		env: process.env.NODE_ENV || 'development',
	},
	db: {
		port: process.env.DB_PORT || 3306,
		database: process.env.DB_NAME || 'seqtest',
	...
	sendgrid: {
		...
		from_email: process.env.FROM_EMAIL || 'shubhamthesmat@gmail.com',
	},
};
